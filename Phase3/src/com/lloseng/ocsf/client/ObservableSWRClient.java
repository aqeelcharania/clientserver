...
public class ObservableSWRClient extends ObservableClient {
	 ...
	 * 
	 * @param message
	 *            The message sends to the server.
	 * @param expectedObject
	 *            The client will wait until it receives an object equals to
	 *            this one.
	 * @return the object received.
	 * @exception IOException
	 *                if an I/O error occurs.
	 */
	public synchronized Object sendAndWaitForReply(Object message,
	 ...
	 * @param message
	 *            The message sends to the server.
	 * @param expectedListOfObject
	 *            The client will wait until it receives an object equals to one
	 ...
	 */
	public synchronized Object sendAndWaitForReply(Object message,
			List expectedListOfObject) throws Exception {
